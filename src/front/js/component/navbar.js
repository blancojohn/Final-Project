      ...
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link as={NavLink} to="/Perros" activeClassName="active">Perros</Nav.Link>
            <Nav.Link as={NavLink} to="/Gatos" activeClassName="active">Gatos</Nav.Link>
            <Nav.Link as={NavLink} to="/Ofertas" activeClassName="active">Ofertas</Nav.Link>
          </Nav>
          <Nav>
            {store.user ? (
              <>
                ...
                <Nav.Link as={NavLink} to="/me" activeClassName="active">Mi Cuenta</Nav.Link>
              ...
              <Nav.Link as={NavLink} to="/register" activeClassName="active">Regístrate / Login</Nav.Link>
            )}
          </Nav>
        </Navbar.Collapse>
      </Container>
